...
public class StatistiquesActivity extends Activity implements OnClickListener {
	...
	private void initFont() {
    	...
    	MakeFont.makeFont((TextView) findViewById(R.id.icon_stat),"#1f8dd6",roboto_font);
    	MakeFont.makeFont(this.stat_title,roboto_font);
    	MakeFont.makeFont((TextView) findViewById(R.id.activity_statistique_button_reset),"#1f8dd6",elegant_font);
    	MakeFont.makeFont(etoile_stat_nb_parties_jouees,"#f29c3b",elegant_font);
    	MakeFont.makeFont(etoile_stat_pourcentage_parties_gagnees,"#f29c3b",elegant_font);
    	...
    	MakeFont.makeFont((TextView) findViewById(R.id.text_stat_nb_belotes),roboto_font);
    	MakeFont.makeFont((TextView) findViewById(R.id.text_stat_nb_capots),roboto_font);
    	MakeFont.makeFont((TextView) findViewById(R.id.text_stat_nb_dedans),roboto_font);
    	MakeFont.makeFont((TextView) findViewById(R.id.text_stat_nb_parties_jouees),roboto_font);
    	MakeFont.makeFont((TextView) findViewById(R.id.text_stat_pourcentage_parties_gagnees),roboto_font);
    	MakeFont.makeFont((TextView) findViewById(R.id.text_stat_temps),roboto_font);
	}
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        case CONFIRM_RESET:
            ...
            builder.setMessage("Voulez-vous vraiment rétinitialiser les statistiques ?")
            .setCancelable(true)
